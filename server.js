...
/* =========================================================
   WEBINAR CONFIGURATION - ✅ FIXED
========================================================= */

// ✅ GOOGLE MEET LINK - YE RAKHO (HARDCODED YA ENV SE)
...
/* ========================================================= 
   REGISTER LEAD - ✅ FIXED: zoomLink RETURN KAREGA
========================================================= */ 
...
app.post("/api/leads", async (req, res) => { 
  try { 
    ...
    /* ------------------------------------------------------- 
       ✅ RESPONSE - YAHAN zoomLink RETURN KARO
    ------------------------------------------------------- */ 
 
    return res.status(201).json({ 
      success: true, 
      message: "Registration successful. Webinar details have been processed.", 
      leadId: lead._id, 
      zoomLink: WEBINAR_MEETING_LINK,  // ✅ YEH ADD KARO - BAHUT IMPORTANT
      whatsappCommunityLink: WHATSAPP_COMMUNITY_LINK, 
    }); 
